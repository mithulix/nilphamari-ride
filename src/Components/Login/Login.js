...
import icon1 from "../images/fi-snsuxl-google-logo.svg";
import icon2 from "../images/fi-cnsuxl-facebook-circle.svg";
import icon3 from "../images/fi-xnsuxl-github.svg";
...
export default function Login() {
 ...
 //Facebook sign/out provider
  ...
  //css
  const linkCss = {textDecoration:"none", color:"#ff6572", cursor:"pointer"};
  ...
  const socialBtn = { width:"2rem", backgroundColor:"#fff", borderRadius:"50%", cursor:"pointer"}
              ...
              <Col md={4} style={InputCss}>
                ...
                <Card.Text style={or}><span style={span}>{newUser ? 'Sign up with' : 'Sign in with'}</span></Card.Text>
                  <Row className="gap-3 text-center">
                    <Col> <img onClick={GoogleSignIn} src={icon1} style={socialBtn} alt=""/> </Col>
                    <Col> <img onClick={FacebookSignIn} src={icon2} style={socialBtn} alt=""/> </Col>
                    <Col> <img onClick={GithubSignIn} src={icon3} style={socialBtn} alt=""/> </Col>
                  </Row>
